...
The third model has an AUC of 0.9598 on the training data and 0.9602 on the testing data. The difference is very small. The KS is 0.7993. Moreover, we can see (on the ROC curve graph) that our classifier is not far from being perfect.
...
The median of the observed values for the AUC of the test data is 0.9599344, the average is 0.959875 with a standard deviation of 0.0008979887. We find these results great.
